...
It is important to dispel some of these misconceptions of what computer science is and who it is for. Media stereotypes of people who work in computing fields don’t always address the reality of the work or the people involved, and connecting students to real computer programmers, app developers and others working in the field can help students see themselves also working in those types of job. To increase interest in computing among girls, for example, invite women working in computer science careers to come to school and give a presentation about their job. Schedule field trips to nearby tech companies locating in southern Califrona, such as Google will do a lot to help students see that CS is within reach. 
Additionally, having students doing collaborative activities, such as pair programming, where students can work and learn from each other. Seeing that their peers's excitement and joy in what they are creating would help them see CS is not such an intimidating or complicated subject.

Computer science is an interdisplinary. Eventhough students don't want to major in computer science in college, they can take the skills - collaboration and problem solving - and apply to a wide variety of different fields, such as liberal arts, health sciences, and visual arts.  
